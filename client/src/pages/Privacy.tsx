      ...
      >
        ...
        <div className="mt-20 px-5 w-full max-w-5xl mx-auto h-full">
          ...
          <ul className="list-disc ml-6 mb-4">
            <li>
              Personal information such as name, email address, shipping
          ...
          <p className="mb-4">
            You can update your account information or unsubscribe from
            marketing emails at any time. Contact us if you wish to delete your
            account or have questions about your data.
          </p>
